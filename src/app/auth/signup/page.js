      ...
      <div className="flex flex-wrap items-center ">
        <div className="hidden w-full xl:block xl:w-1/2 h-screen">
          <div className="py-20 px-26 flex flex-col space-y-5 justify-center items-center text-center">
           ...
           <h1 className=" text-4xl text-[#002222ed] font-bold">eVault</h1>
            </Link>
            <p className=" text-[#002222ed] w-11/12">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-20">
            <h2 className="mb-9 text-4xl font-bold text-[#002222ed] sm:text-title-xl2">
              Sign Up to eVault
            </h2>
            <form>
              {/* Name */}
              <div className="mb-4">
                <label className="mb-2.5 block font-medium text-[#002222ed]">
                  UserName
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-[#002222ed] outline-none"
                  />
              ...
              <div className="mb-5">
                <input
                  ...
                  className="w-full cursor-pointer rounded-lg bg-[#002222ed] p-4 text-white transition hover:bg-opacity-90"
                />
              </div>
              <div className="mt-6 text-center text-[#002222ed]">
                <p>
