...
export default () => {
    ...
    return (
        <footer className="pt-1 bg-[#002222]">
            <div className="max-w-screen-xl mx-auto px-2 md:px-8">
                ...
                <div className="lg:mb-0 text-white">
                   <img src="/Images/img1.png" width={150} height={150}/>
                      <ul className="list-none p-0 text-sm text-white">
                    <li>About</li>
                        <li>Legal Records</li>
                        <li>Articles</li>
                        <li>Contact us</li>
            ...
            <div className="mb-4 lg:mb-0 text-white">
                <h4 className="text-lg font-bold mb-2">Legal Records</h4>
                <ul className="list-none p-0 text-sm">
               <li><a href="/terms-of-service" className="hover:text-white">Terms of Service</a></li>
                <li><a href="/privacy-policy" className="hover:text-white">Privacy Policy</a></li>
                <li><a href="/cookie-policy" className="hover:text-white">Cookie Policy</a></li>
                <li><a href="/cookie-policy" className="hover:text-white">Disclaimer</a></li>
            
                 </ul>
            </div>

            <div className="mb-4 lg:mb-0 text-white">
                <h4 className="text-lg font-bold mb-2">Articles</h4>
                <ul className="list-none p-0 text-sm">
              <link rel='https://theprint.in/judiciary/no-paper-files-all-case-records-on-laptops-supreme-court-holds-first-paperless-proceedings/433505/'>
                No Paper files all records on laptop
              </link>
                 </ul>
            ...
            <div className="mb-4 lg:mb-0 text-white">
                <h4 className="text-lg font-bold mb-2 text-white">Contact Us</h4>
                <p className='text-sm'>123 Street Name<br/>City, Country<br/>Email: info@example.com<br/>Phone: +123 456 7890</p>
            </div>

            <div>
                <h4 className="text-lg font-bold mb-2  text-white">Connect with us</h4>
                <form className="mt-3">
                    <input type="email" placeholder="Your email" className="bg-gray-800 text-white rounded py-2 px-4 w-full focus:outline-none focus:ring focus:border-blue-300"/>
                    <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mt-2 focus:outline-none focus:ring focus:border-blue-300">Subscribe</button>
                </form>
            </div>
                </div>
