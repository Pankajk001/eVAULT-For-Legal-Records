...
export default () => {
    ...
    return (
        <footer className="pt-10   bg-[#002222]">
                    ...
                    <div className="flex-1 mt-6 md:mt-0">
                        <form  className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                <svg className="w-6 h-6 text-gray-200 absolute left-3 inset-y-0 my-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                            ...
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-text-primary   bg-bg-secondary hover:bg-opcaity-90  active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
